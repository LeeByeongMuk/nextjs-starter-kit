...
import EmptyItem from '@/app/post/(list)/_components/EmptyItem';
import ListItem from '@/app/post/(list)/_components/Item';
import LoadingList from '@/app/post/(list)/_components/LoadingList';
import { PostListData } from '@/app/post/_types/api';
